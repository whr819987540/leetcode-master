...
int main()
{
    ...
    {
        vector<int> data = {381, 157, 157, 134};
        int a, b;
        a = s.wiggleMaxLength(data);
        b = s.wiggleMaxLength2(data);
        cout << a << " " << b << endl;
    }
